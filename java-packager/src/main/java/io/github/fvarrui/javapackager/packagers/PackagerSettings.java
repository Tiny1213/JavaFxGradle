...
public class PackagerSettings {
	...
	public PackagerSettings setZipName(String zipName){
		this.zipName=zipName;
		Logger.info("set zip name "+zipName);
		return this;
	}
	...
	public String toString() {
		return "PackagerSettings [outputDirectory=" + outputDirectory + ", licenseFile=" + licenseFile + ", iconFile="
				...
				+ macConfig + ", createTarball=" + createTarball + ", createZipball=" + createZipball + " zipName = "+zipName+", extra="
